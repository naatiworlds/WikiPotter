/**
 * @file UserNotLoginIcon.jsx
 * @description Componente que muestra un ícono representativo de un usuario que no está logueado. El ícono consiste en un círculo que simboliza el rostro de un usuario y una línea debajo que representa el cuerpo o la conexión al sistema, similar al ícono de usuario logueado pero representando un estado de usuario no autenticado.
 * @dependencies
 * - React (para usar JSX).
 * @version 1.0
 * @date 2024
...
/**
 * Componente funcional que muestra un ícono SVG representando un usuario no logueado.
 * El ícono consta de un círculo (representando la cabeza del usuario) y una línea curva
 * debajo que simboliza el cuerpo o la conexión al sistema.
 * 
 ...
 * 
 * @returns {JSX.Element} Un ícono SVG representando un usuario no logueado.
 */
